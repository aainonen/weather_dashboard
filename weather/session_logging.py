...
def register_session_logging(app):
    ...
    def start_timer():
        ...
        g.search_location   = None         # initialize search_location
    ...
    def log_session(response):
        ...
        session_metric = SessionMetric(
            ...
            search_location  = getattr(g, 'search_location', None)
        )
        ...
        try:
            ...
            current_app.logger.info(
                "Logged session %s: ip=%s, duration=%.2fs, location=%s",
                session_metric.id, ip, duration, session_metric.search_location
            )
